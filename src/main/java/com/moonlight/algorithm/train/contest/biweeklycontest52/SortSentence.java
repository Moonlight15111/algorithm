 ...
 *
 * 输入：s = "is2 sentence4 This1 a3"  输出："This is a sentence"
 * 解释：将 s 中的单词按照初始位置排序，得到 "This1 is2 a3 sentence4" ，然后删除数字。
 *
 * 输入：s = "Myself2 Me1 I4 and3"  输出："Me Myself and I"
...
public class SortSentence {
    ...
    public static String sortSentence(String s) {
        ...
        for (int i = 0, j; i < split.length; i++) {
            while ((j = getIndex(split[i]) - 1) != i) {
                String t = split[i];
                split[i] = split[j];
                split[j] = t;
            }
