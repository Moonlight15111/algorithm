 ...
 *
 * 输入：firstWord = "acb", secondWord = "cba", targetWord = "cdb"   输出：true
 * 解释：
 ...
 *
 * 输入：firstWord = "aaa", secondWord = "a", targetWord = "aab"    输出：false
 * 解释：
 ...
 * 由于 0 + 0 != 1 ，返回 false
 *
 * 输入：firstWord = "aaa", secondWord = "a", targetWord = "aaaa"    输出：true
 * 解释：
 * firstWord 的数值为 "aaa" -> "000" -> 0
 * secondWord 的数值为 "a" -> "0" -> 0
