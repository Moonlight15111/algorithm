package com.moonlight.algorithm.train.contest.biweeklycontest54;
...
public class ChalkReplacer {
    ...
    public static void main(String[] args) {
        int[] a = {5, 1, 5}, b = {3, 4, 1, 2};
        System.out.println(chalkReplacer(a, 22));
        System.out.println(chalkReplacer(b, 25));
    }
