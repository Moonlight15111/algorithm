...
public class CanVisitAllRooms {
    ...
    public static void main(String[] args) {
        ...
        a.add(Collections.singletonList(3));
        a.add(new ArrayList<>());

        b.add(Arrays.asList(1, 3));
        b.add(Arrays.asList(3, 0, 1));
        b.add(Collections.singletonList(2));
        b.add(Collections.singletonList(0));

        System.out.println(canVisitAllRooms(a));
        System.out.println(canVisitAllRooms(b));
    }
    ...
    private static void dfs(int idx, boolean[] visited, List<List<Integer>> rooms) {
        visited[idx] = true;
